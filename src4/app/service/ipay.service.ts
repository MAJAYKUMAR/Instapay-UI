...
import { ReoccurringDeposit } from './Recurringdeposit';
...
export class IpayService {
  ...
  addMoney(reoccurringdeposit:ReoccurringDeposit){
    ...
    this.http.post<ReoccurringDeposit>(this.url+"/reocurring",reoccurringdeposit)
    .subscribe(ReoccurringDeposit=> alert("Amount Deposited successfully ") );
...
getBalance():Observable<any>{
  ...
  return   this.http.get(this.url+"/getbalance");
